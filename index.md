...
humandate: "July 24th-25th, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 5:00pm CET"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-07-24      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-07-25        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Jonathan Hartman", "Tarek Iraki"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["hartman@itc.rwth-aachen.de", "t.iraki@fz-juelich.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.otc.coscine.dev/2025-07-24-python-sklearn # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<iframe
  src="https://cryptpad.fr/form/#/2/form/view/BT1wZSZP6F2J6sdVf6+wODQAzDFjVdy2IcBIg7-EmhQ/embed/"
  frameborder="0"
  width="100%"
  height="800px"
  scrolling="auto">
...
<p id="who">
  <strong>Who:</strong>
  This workshop is offered free of charge for anyone who wishes to attend, but is primarily focused
  on students and early career researchers at institutions within the Nordrhein-Westfalen area.

  <strong>
    Participants will be assumed to have a basic understanding of Python. You should have a basic
    understanding of how to run Python code in a Jupyter Notebook, and be able to write for loops,
    conditional statments, use functions, and import libraries.
  </strong>
</p>
...
<p><a href="https://cryptpad.fr/form/#/2/form/view/0ZcW5VDTvuiBUmplpe70wa5MHwTtP+ueSmRCaSs1FIk/">Pre-workshop Survey</a></p>
<p><a href="https://cryptpad.fr/form/#/2/form/view/5EeRx0FHh2925fqX4euBfAldzkXDVm0UOzIGRh8L9Js/">Post-workshop Survey</a></p>
